...
ABUTTON_Y = (VIRTUAL_HEIGHT_GB / 2) * SCALE_FACTOR + DPAD_DIAGONAL_WIDTH
BBUTTON_X = (VIRTUAL_WIDTH - 64) * SCALE_FACTOR
BBUTTON_Y = (VIRTUAL_HEIGHT_GB / 2) * SCALE_FACTOR + DPAD_DIAGONAL_WIDTH * 2 + 3
SELECT_X = (VIRTUAL_WIDTH / 2 - 56) * SCALE_FACTOR
START_X = (VIRTUAL_WIDTH/ 2 - 14) * SCALE_FACTOR
OPTIONS_Y = (VIRTUAL_HEIGHT_GB - 30) * SCALE_FACTOR
