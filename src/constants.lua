...
WINDOW_HEIGHT = 144 * SCALE_FACTOR * 1
--864
...
VIRTUAL_WIDTH =  160
VIRTUAL_HEIGHT = 144
VIRTUAL_HEIGHT_GB = 144 * 1
OST_VOLUME = .1
OST_DEFAULT_VOLUME = .1
SAVE_DATA_LOADED = nil
SAVEFILE_SELECT = "empty"
...
GREEN_TUNIC_CHEST_OPENED = false
MAGIC_POTION_CHEST_OPENED = false
TOME1_CHEST_OPENED = false
LUTE_CHEST_OPENED = false
LUTE_STRING_VOLUME = 0.2
...
BAT_ATTACK_SPEED = 2
FAST_SELECT_TIMER = .2
MINERAL_HARVEST_RESET = 30
AQUIS_FOCUS_GROW = 1.5
...
GECKO_CORRUPTED_PARTICLE = {109/255, 79/255, 226/255, 255/255, 25/255, 0/255, 20/255, 0/255}
GECKO_SPLASH_PARTICLE = {0/255, 0/255, 100/255, 255/255, 10/255, 40/255, 200/255, 0/255}
...
CORRUPT_GECKO_COLOR ={163/255,40/255,226/255,1}
CLEANSED_GECKO_COLOR ={205/255,115/255,32/255,1}
SPLASHED_GECKO_COLOR ={4/255,80/255,200/255,1}
DAMAGED_GECKO_COLOR ={230/255,20/255,20/255,1}
      --CORRUPT
      --love.graphics.setColor(126/255,0,192/255,1)
      --CLEANSED
      love.graphics.setColor(235/255,152/255,12/255,1)
      --SPLASHED
      --love.graphics.setColor(4/255,80/255,200/255,1)
      --DAMAGE
