...
function Player:pitTopLeftCollide(chasm)
  ...
  if chasmTopLeftX > chasm.x and chasmTopLeftX < chasm.x + chasm.width then
    if chasmTopLeftY + chasmTopLeftHeight - 1 > chasm.y + 2 and chasmTopLeftY < chasm.y + chasm.height then
      self.TLCollide = self.TLCollide + 1
      self.chasmFalling = true
      return true
...
function Player:pitTopRightCollide(chasm)
  ...
  if chasmTopRightX > chasm.x and chasmTopRightX < chasm.x + chasm.width then
    if chasmTopRightY + chasmTopRightHeight > chasm.y and chasmTopRightY < chasm.y + chasm.height then
      self.TRCollide = self.TRCollide + 1
      self.chasmFalling = true
      return true
    end
...
function Player:pitBottomLeftCollide(chasm)
  ...
  if chasmBottomLeftX > chasm.x and chasmBottomLeftX < chasm.x + chasm.width then
    if chasmBottomLeftY + chasmBottomLeftHeight > chasm.y and chasmBottomLeftY < chasm.y + chasm.height then
      self.BLCollide = self.BLCollide + 1
      self.chasmFalling = true
      return true
    end
...
function Player:pitBottomRightCollide(chasm)
  ...
  if chasmBottomRightX > chasm.x and chasmBottomRightX < chasm.x + chasm.width then
    if chasmBottomRightY + chasmBottomRightHeight > chasm.y and chasmBottomRightY < chasm.y + chasm.height then
      self.BRCollide = self.BRCollide + 1
      self.chasmFalling = true
      return true
    end
