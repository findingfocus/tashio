...
require 'src/states/entity/GeckoFleeState'
require 'src/states/entity/BoarWalkState'
require 'src/states/entity/BoarFleeState'
...
aquis2 = love.graphics.newImage('graphics/elements10x10/aquis.png')
...
gTextures = {
  ...
  ['villager2-walk'] = love.graphics.newImage('graphics/villager2Atlas.png'),
  ['villagerKid-walk'] = love.graphics.newImage('graphics/villagerKidAtlas.png'),
  ...
  ['boar'] = love.graphics.newImage('graphics/boarAtlas.png'),
...
gFrames = {
  ...
  ['villager2-walk'] = GenerateQuads(gTextures['villager2-walk'], TILE_SIZE, TILE_SIZE),
  ['villagerKid-walk'] = GenerateQuads(gTextures['villagerKid-walk'], TILE_SIZE, TILE_SIZE),
  ...
  ['boar'] = GenerateQuads(gTextures['boar'], TILE_SIZE, TILE_SIZE),
...
ost = {
  ['titleTrack'] = love.audio.newSource('music/titleTrack.ogg', 'stream'),
  ['dungeonTrack'] = love.audio.newSource('music/dungeonTrack.ogg', 'stream'),
  ['exploreTrack'] = love.audio.newSource('music/exploreTrack.ogg', 'stream'),
  ['magesCastleTrack'] = love.audio.newSource('music/magesCastleTrack.ogg', 'stream'),
  ['villageTrack'] = love.audio.newSource('music/villageTrack.ogg', 'stream'),
  ['darkForestTrack'] = love.audio.newSource('music/darkForestTrack.ogg', 'stream'),
}
...
--SFX TABLE
sfx = {
  ['bat-damaged'] = love.audio.newSource('sounds/SFX/Bat_Damaged_v4.ogg', 'static'),
  ['bat-spit'] = love.audio.newSource('sounds/SFX/Bat_Spit_v3.ogg', 'static'),
  ['bat-flap'] = love.audio.newSource('sounds/SFX/Bat_Wing_Flap_v4.ogg', 'static'),
  ['cleanse'] = love.audio.newSource('sounds/SFX/Cleanse_Corruption_v2.ogg', 'static'),
  ['coin-pickup'] = love.audio.newSource('sounds/SFX/CoinPickup_v1.ogg', 'static'),
  ['tashio-falling'] = love.audio.newSource('sounds/SFX/Falling_v1.ogg', 'static'),
  ['falling2'] = love.audio.newSource('sounds/SFX/Falling_v2.ogg', 'static'),
  ['game-over1'] = love.audio.newSource('sounds/SFX/GAME_OVER_V1.ogg', 'static'),
  ['game-over2'] = love.audio.newSource('sounds/SFX/GAME_OVER_V2.ogg', 'static'),
  ['game-over3'] = love.audio.newSource('sounds/SFX/GAME_OVER_V3.ogg', 'static'),
  ['item-equip1'] = love.audio.newSource('sounds/SFX/Item_Equip_v1.ogg', 'static'),
  ['item-equip2'] = love.audio.newSource('sounds/SFX/Item_Equip_v2.ogg', 'static'),
  ['item-equip3'] = love.audio.newSource('sounds/SFX/Item_Equip_v3.ogg', 'static'),
  ['item-pickup'] = love.audio.newSource('sounds/SFX/ITEM_PICKUP_V1.ogg', 'static'),
  ['open-chest'] = love.audio.newSource('sounds/SFX/Open_Chest_v2.ogg', 'static'),
  ['pause1'] = love.audio.newSource('sounds/SFX/Pause_v1.ogg', 'static'),
  ['pause2'] = love.audio.newSource('sounds/SFX/Pause_v2.ogg', 'static'),
  ['pause3'] = love.audio.newSource('sounds/SFX/Pause_v3.ogg', 'static'),
  ['purchase1'] = love.audio.newSource('sounds/SFX/Purchase_v1.ogg', 'static'),
  ['purchase2'] = love.audio.newSource('sounds/SFX/Purchase_v2.ogg', 'static'),
  ['push-crate'] = love.audio.newSource('sounds/SFX/Push_Crate_v1.ogg', 'static'),
  ['push-rock'] = love.audio.newSource('sounds/SFX/Push_Rock_v1.ogg', 'static'),
  ['ruby-pickup'] = love.audio.newSource('sounds/SFX/Ruby_Pickup_v3.ogg', 'static'),
  ['ruby-unsocket'] = love.audio.newSource('sounds/SFX/Ruby_Unsocket_v3.ogg', 'static'),
  ['tashio-hurt1'] = love.audio.newSource('sounds/SFX/Tashio_Hurt_v2.ogg', 'static'),
  ['tashio-hurt2'] = love.audio.newSource('sounds/SFX/Tashio_Hurt_v4.ogg', 'static'),
  ['ui-scroll1'] = love.audio.newSource('sounds/SFX/UI_Scroll_v1.ogg', 'static'),
  ['ui-scroll2'] = love.audio.newSource('sounds/SFX/UI_Scroll_v2.ogg', 'static'),
  ['ui-select1'] = love.audio.newSource('sounds/SFX/UI_Select_v1.ogg', 'static'),
  ['ui-select2'] = love.audio.newSource('sounds/SFX/UI_Select_v2.ogg', 'static'),
  ['use-potion'] = love.audio.newSource('sounds/SFX/Use_Potion_v3.ogg', 'static'),
  ['warp-zone'] = love.audio.newSource('sounds/SFX/Warp_Location_v4.ogg', 'static'),
  ['crate-break'] = love.audio.newSource('sounds/SFX/Crate_Break_v2.ogg', 'static'),
  ['idol-heal1'] = love.audio.newSource('sounds/SFX/Idol_v1.ogg', 'static'),
  ['idol-heal2'] = love.audio.newSource('sounds/SFX/Idol_v7.ogg', 'static'),
  ['idol-gong1'] = love.audio.newSource('sounds/SFX/IdolGong_v1.ogg', 'static'),
  ['fire-blast2'] = love.audio.newSource('sounds/SFX/Fire_Blast_v2.ogg', 'static'),
  ['fire-blast-spinning2'] = love.audio.newSource('sounds/SFX/Fire_Blast_Spinning_v2_loop.ogg', 'static'),
  ['dialogue1'] = love.audio.newSource('sounds/SFX/Dialogue_01_Short.ogg', 'static'),
}
...
sounds = {
  ['beep'] = love.audio.newSource('music/beep.ogg', 'static'),
  ['select'] = love.audio.newSource('music/select.ogg', 'static'),
