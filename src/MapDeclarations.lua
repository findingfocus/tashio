...
table.insert(MAP[7][2].signposts, SignPost(2 * TILE_SIZE, 5 * TILE_SIZE, '12345 123450 123456 This is evenly more text now isnt it? This should be on page 2 now... And lastly, this text should be on page 3'))
