...
MAP[1][1] = {
    ...
    GRASS_LE, GRASS   , GRASS   , DIRT_PATH, DIRT_PATH, DIRT_PATH, BRICK_BROWN, BRICK_BROWN, BRICK_BROWN, BRICK_BROWN,
    GRASS_LE, GRASS   , GRASS   , DIRT_PATH   , TREE_TL   , TREE_TR   , FLOWER   , GRASS   , GRASS   , GRASS_RE,
