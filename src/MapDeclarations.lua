...
table.insert(MAP[7][2].signposts, SignPost(2 * TILE_SIZE, 5 * TILE_SIZE, 'This is a test sentence where we can see that the words can be cut off from one page to the next.'))
