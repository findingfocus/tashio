...
MAP[10][20].ost = 'magesCastleTrack'
...
--function DialogueBox:init(x, y, text, option, npc, index)
  ...
  table.insert(MAP[7][5].dialogueBox, DialogueBox(-2 * TILE_SIZE, -TILE_SIZE, 'You found an ancient tome! It is engraved with elegant music from times of old.  There is a symbol etched on the bottom corner, and it also bears a message.  \"The sound of the heart keeps corruption away.\" ',  nil, 1))
  ...
  MAP[10][19].dialogueBox[14].skippable = false
